...
var PlaylistHelper = (function (_super) {
    __extends(PlaylistHelper, _super);
    function PlaylistHelper() {
        _super.apply(this, arguments);
        this.repeat = false;
    }
    PlaylistHelper.prototype.init = function () {
        var _this = this;
        this.playstate = 2 /* STOPPED */;
        this.songlist_element = this.element.getElementsByClassName("songlist")[0];
    ...
    PlaylistHelper.prototype._setPlayState = function (state) {
        this.playstate = state;
        if (this.playstate == 0 /* PLAYING */) {
            this.parent.getHelper("PlayingHelper").play();
        } else if (this.playstate == 1 /* PAUSED */ || this.playstate == 2 /* STOPPED */) {
            this.parent.getHelper("PlayingHelper").pause();
        }
    };
    ...
    */
    PlaylistHelper.prototype.get_song_at = function (index) {
        var element = this.get_element_at(index);
        var songID = element.attributes["data-song-id"];
        return this.parent.getTunr().library.get_song_by_id(songID);
    };

    /**
    * Gets the playlist HTML element at the specified playlist index.
    */
    PlaylistHelper.prototype.get_element_at = function (index) {
    ...
    */
    PlaylistHelper.prototype.count = function () {
    ...
    */
    PlaylistHelper.prototype._find_index_of_element = function (element) {
    ...
    */
    PlaylistHelper.prototype.get_playing_index = function () {
    ...
    PlaylistHelper.prototype.getSongTime = function () {
        return this.audio.currentTime;
    };

    // Audio controls
    PlaylistHelper.prototype.play = function () {
    ...
    PlaylistHelper.prototype.pause = function () {
        if (this.playstate == 0 /* PLAYING */) {
            this.audio.pause();
    ...
    PlaylistHelper.prototype.stop = function () {
    ...
    PlaylistHelper.prototype.next = function () {
    ...
    PlaylistHelper.prototype.prev = function () {
    ...
    PlaylistHelper.prototype.playIndex = function (index) {
        ...
        // Change play listing
        this.parent.getHelper("PlayingHelper").changeSong(song);
    ...
    PlaylistHelper.prototype.trackEnded = function () {
        this.next();
    };

    PlaylistHelper.prototype._renderElement = function (song) {
        var _this = this;
    ...
    PlaylistHelper.prototype.set_controls_timeout = function () {
        var _this = this;
    ...
    PlaylistHelper.prototype.hide_controls = function () {
    ...
    PlaylistHelper.prototype.show_controls_at = function (index) {
        var _this = this;
        this.hide_controls();
        var song_element = this.get_element_at(index);
    ...
    PlaylistHelper.prototype.addSong = function (song) {
    ...
    PlaylistHelper.prototype.move_song = function (srcIndex, targetIndex) {
    ...
    PlaylistHelper.prototype.remove_by_index = function (index) {
    ...
    PlaylistHelper.prototype.nextIndex = function () {
    ...
    PlaylistHelper.prototype.prevIndex = function () {
...
//# sourceMappingURL=PlaylistHelper.js.map
